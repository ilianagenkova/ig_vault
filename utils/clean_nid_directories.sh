...
find /lfs/h2/emc/stmp/$USER/*.nid0* -type d -mtime +2 -print > list2delete  # list directories older than 2 days
...
#cbqs01
find /lfs/h2/emc/stmp/$USER/*.cbqs01 -type d -mtime +2 -print > list2delete
for f in $(cat list2delete) ; do
     rm -rf "$f"
done
rm -rf list2delete
...
find /lfs/h2/emc/ptmp/$USER/*.cbqs01 -type d -mtime +2 -print > list2delete
for f in $(cat list2delete) ; do
     rm -rf "$f"
done
rm -rf list2delete
...
find /lfs/h2/emc/obsproc/noscrub/$USER/*.cbqs01 -type d -mtime +2 -print > list2delete
for f in $(cat list2delete) ; do
     rm -rf "$f"
done
rm -rf list2delete
