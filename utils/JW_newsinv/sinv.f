...
!  get filename argument
      ...
      NARG=IARGC()
      IF(NARG/=1) THEN
        write(6,*)'Usage: sinv <satbufrfile> will print inventory of satellites by platofrm and instrument'
        CALL EXIT(2)
      ENDIF
      call getarg(1,file)
      ...
      nret=-1
      do while(nret<0)
         call ufbtab(lunbf,said,2,maxa,nret,'SAID SIID')
         do n=1,abs(nret)
         i = said(1,n)
         j = said(2,n)
...
1     format(a14,2x,a14,2x,a8)
      ...
      if(isat(i,j).gt.0) then 
         ...
         print'(i3.3,2x,a16,2x,i10,2x,i3.3,a80)',i,ci,isat(i,j),j,cj
      endif
      enddo
      enddo; print*
...
!-----------------------------------------------------------------------
      ...
      if(first)then
         do i=1,1000
         read(sadline(i),'(i3,a16)',err=2) said,saic(said)
...
data sadline(6) /'020 SPOT-1'/
data sadline(7) /'021 SPOT-2'/
data sadline(8) /'022 SPOT-3'/
data sadline(9) /'023 SPOT-4'/
data sadline(10) /'040 OERSTED'/
data sadline(11) /'041 CHAMP'/
data sadline(12) /'042 TerraSAR-X'/
data sadline(13) /'043 TanDEM-X'/
data sadline(14) /'044 PAZ'/
data sadline(15) /'046 SMOS'/
data sadline(16) /'047 CryoSat-2'/
data sadline(17) /'048 AEOLUS'/
data sadline(18) /'050 METEOSAT-3'/
data sadline(19) /'051 METEOSAT-4'/
data sadline(20) /'052 METEOSAT-5'/
data sadline(21) /'053 METEOSAT-6'/
data sadline(22) /'054 METEOSAT-7'/
data sadline(23) /'055 METEOSAT-8'/
data sadline(24) /'056 METEOSAT-9'/
data sadline(25) /'057 METEOSAT-10'/
data sadline(26) /'058 METEOSAT-1'/
data sadline(27) /'059 METEOSAT-2'/
data sadline(28) /'060 ENVISAT'/
data sadline(29) /'061 Sentinel-3A'/
data sadline(30) /'062 Sentinel-1A'/
data sadline(31) /'063 Sentinel-1B'/
data sadline(32) /'064 Sentinel-5P'/
data sadline(33) /'065 Sentinel-3B'/
data sadline(34) /'066 Sentinel-6A'/
data sadline(35) /'067 Sentinel-6B'/
data sadline(36) /'070 METEOSAT-11'/
...
data sadline(213) /'854 Non-specific mixture'/
