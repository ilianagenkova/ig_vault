...
###PUSH
 ##scp path/on/Cactus/testC2D iliana.genkova@ddxfer04.wcoss2.ncep.noaa.gov:/lfs/h2/emc/obsproc/noscrub/iliana.genkova/testC2D
   ...
   scp -r /lfs/h2/emc/obsproc/noscrub/iliana.genkova/CRON/GMI2/com/obsproc/v1.1/* iliana.genkova@ddxfer.wcoss2.ncep.noaa.gov:/lfs/h2/emc/obsproc/noscrub/iliana.genkova/4Haixia_GMI/.
###or
###PULL
