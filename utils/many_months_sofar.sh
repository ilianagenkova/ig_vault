...
for mm in {04..05} # Enter the month range
do
...
# htar -tvf /NCEPPROD/hpssprod/runhistory/rh2023/202312/20231201/dcom_20231201.tar | grep -e xx121 -e b001
