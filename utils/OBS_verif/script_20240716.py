...
mySTMP = '/lfs/h1/ops/prod/com/obsproc/v1.2/gfs.20240721/00/atmos' #'C:/Users/jason.welsh/Downloads'
#STMP = subprocess.call('"$STMP"',shell=False)
myCOMROOT = '/lfs/h1/ops/prod/com/obsproc/v1.2/gfs.20240721/00/atmos' #'C:/Users/jason.welsh/Downloads'
...
prefix_out = "bufr_d"
#theFiles_in = [filename for filename in os.listdir('.') if filename.startswith(prefix_out)]
...
messages = output1.iloc[:,1] - output2.iloc[:,1]

subsets = output1.iloc[:,2] - output2.iloc[:,2]

bytess = output1.iloc[:,3] - output2.iloc[:,3]
